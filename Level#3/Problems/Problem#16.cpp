...
{
	int NumberofZeros = CountNumberInMatrix(Matrix, 0, Rows, Cols);
	int NumberOfOtherNumber = (Rows*Cols) - NumberofZeros;
	if (NumberofZeros > NumberOfOtherNumber)
		return true;
	else
		return false;
}
...
int main()
{
	int Matrix[3][3] = { {1,2,3},{0,0,2},{2,2,0} };
